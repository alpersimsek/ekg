...
BASE_CHECKPOINT = REPO_ROOT / "secili_model_adaylari" / "rba02_final_aday" / "best_model.pt"
OUTPUT_ROOT = REPO_ROOT / "secili_model_adaylari" / "rba02_final_aday" / "tuning"


RUN_CONFIGS = [
    {
        "run_name": "ft01_lr1e4_e6_fn125_fr175_light",
        "epochs": 6,
        "lr": 1e-4,
        "weight_decay": 1e-4,
        "augment": "light",
        "focus_normal_weight": 1.25,
        "focus_ritim_weight": 1.75,
    },
    {
        "run_name": "ft02_lr1e4_e6_fn125_fr150_light",
        "epochs": 6,
        "lr": 1e-4,
        "weight_decay": 1e-4,
        "augment": "light",
    ...
    {
        "run_name": "ft03_lr5e5_e8_fn150_fr175_light",
        "epochs": 8,
        "lr": 5e-5,
        "weight_decay": 1e-4,
        "augment": "light",
    ...
    {
        "run_name": "ft04_lr5e5_e8_fn125_fr175_none",
        "epochs": 8,
        "lr": 5e-5,
        "weight_decay": 1e-4,
        "augment": "none",
    ...
    {
        "run_name": "ft05_lr1e4_e6_fn150_fr200_none",
        "epochs": 6,
        "lr": 1e-4,
        "weight_decay": 1e-4,
        "augment": "none",
    ...
    {
        "run_name": "ft06_lr5e5_e8_fn150_fr200_light_wd5e5",
        "epochs": 8,
        "lr": 5e-5,
        "weight_decay": 5e-5,
        "augment": "light",
...
def main() -> None:
    ...
    (OUTPUT_ROOT / "tuning_plan.json").write_text(json.dumps(plan, ensure_ascii=False, indent=2), encoding="utf-8")
    ...
    (OUTPUT_ROOT / "tuning_summary.json").write_text(json.dumps(final, ensure_ascii=False, indent=2), encoding="utf-8")
