...
OUTPUT_ROOT = REPO_ROOT / "artifacts" / "uc_sinif_bucket_aware_sweep"


RUN_CONFIGS = [
    {
        "run_name": "ba01_fn20_fr20_none_aug",
    ...
    {
        "run_name": "ba02_fn30_fr20_none_aug",
        "focus_normal_weight": 3.0,
        "focus_ritim_weight": 2.0,
        "augment": "none",
        "weight_decay": 1e-4,
    },
    {
        "run_name": "ba03_fn20_fr30_none_aug",
        "focus_normal_weight": 2.0,
        "focus_ritim_weight": 3.0,
        "augment": "none",
        "weight_decay": 1e-4,
    },
    {
        "run_name": "ba04_fn30_fr30_none_aug",
        "focus_normal_weight": 3.0,
        "focus_ritim_weight": 3.0,
        "augment": "none",
        "weight_decay": 1e-4,
    ...
    {
        "run_name": "ba05_fn20_fr20_light_aug",
        "focus_normal_weight": 2.0,
        "focus_ritim_weight": 2.0,
        "augment": "light",
        "weight_decay": 1e-4,
    ...
    {
        "run_name": "ba06_fn30_fr20_light_aug",
        "focus_normal_weight": 3.0,
        "focus_ritim_weight": 2.0,
        "augment": "light",
        "weight_decay": 1e-4,
    ...
    {
        "run_name": "ba07_fn20_fr30_light_aug",
        "focus_normal_weight": 2.0,
        "focus_ritim_weight": 3.0,
        "augment": "light",
        "weight_decay": 1e-4,
    ...
    {
        "run_name": "ba08_fn25_fr25_light_aug_wd5e4",
        "focus_normal_weight": 2.5,
        "focus_ritim_weight": 2.5,
        "augment": "light",
        "weight_decay": 5e-4,
    },
]
...
def main() -> None:
    ...
    (OUTPUT_ROOT / "bucket_aware_plan.json").write_text(json.dumps(plan, ensure_ascii=False, indent=2), encoding="utf-8")
    ...
    (OUTPUT_ROOT / "bucket_aware_summary.json").write_text(json.dumps(final, ensure_ascii=False, indent=2), encoding="utf-8")
